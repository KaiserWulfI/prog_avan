 ...
 * Juego de gato implementado usando solo funciones y variables globales
 * Incluye IA con algoritmo minimax
 */
#include <iostream>
#include <vector>
#include <limits>
...
void jugar() {
    std::cout << "=== TIC TAC TOE (sin clases) ===" << std::endl;
